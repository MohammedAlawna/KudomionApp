...
@dso_cache = dso_local local_unnamed_addr global [840 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 148747688, ; hash 0x8ddb5a8, from name: aot-KudomionApp.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1434138983, ; hash 0x557b3967, from name: aot-KudomionApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-KudomionApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 264
	...
	%struct.DSOCacheEntry {
		i64 2001273273, ; hash 0x774901b9, from name: KudomionApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-KudomionApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 375
	...
	%struct.DSOCacheEntry {
		i64 2326928510, ; hash 0x8ab21c7e, from name: libaot-KudomionApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-KudomionApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 446
	...
	%struct.DSOCacheEntry {
		i64 3205066945, ; hash 0xbf0970c1, from name: libaot-KudomionApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-KudomionApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 636
	...
	%struct.DSOCacheEntry {
		i64 3764237910, ; hash 0xe05db656, from name: KudomionApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-KudomionApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 741
